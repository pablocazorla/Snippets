...
<body>
      ...
      <div class="collapser show" id="language-section">
        <div class="collapser-header">
          ...
          <div class="collapser-content">
            ...
            <li data-bind="css: {current:current},click:setCurrent,visible:hasSnippets">
    ...
    <div id="snippet-list-section">
      <ul id="snippet-list" data-bind="foreach: list">    
        <li data-bind="css: {current:current},click:setCurrent">
          ...
          <span class="edit" data-bind="click:edit"><i class="fa fa-pencil"></i> edit</span>
        </li>
      </ul>
  ...
  <div id="modal">
    <div id="modal-dimmer" class="modal-close"></div>
    <div id="modal-body">
      <div id="modal-close" class="modal-close" title="close"><i class="fa fa-close"></i></div>
      <div id="modal-content" class="clearfix">
        <div id="snippet-data-editor">
          <h3>Edit Snippet</h3>
          <fieldset>
            <label class="required" for="">Title:</label>
            <input type="text" placeholder="Title" value="" data-bind="value:title">
          </fieldset>
          <div class="row">
            <div class="col-6">
              <fieldset>
                <label class="required" for="">Collection:</label>
                <select data-bind="options:collection_options(),optionsText:'title',value:collection_id"></select>
              </fieldset>
            </div>
            <div class="col-6">
              <fieldset>
                <label class="required" for="">Language:</label>
                <input type="text" placeholder="Title" value="" data-bind="value:language_title">
              </fieldset>
            </div>
          </div>
        </div>
